...
int main(int argc, char *argv[]) {
    ...
    // End timer
    clock_t end = clock();
    long int ticks_malloc = end-begin;
    ...
    long int ticks_memcpy = end-begin
    ...
    long int ticks_kernel = end-begin;
    ...
    long int ticks_free = end-begin;
   
    printf("GPU,%i,%li,%li,%li,%li\n", XSIZE, ticks_malloc, ticks_memcpy, ticks_kernel, ticks_free);
